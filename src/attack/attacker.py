...
class Attacker:
    ...
    def attack(self):
        ...
        self.processed_datasets['train'] = self.processed_datasets['train'].map(detox, with_indices=True, num_proc=1)
        self.processed_datasets['test'] = self.processed_datasets['test'].map(detox, with_indices=True, num_proc=1)
